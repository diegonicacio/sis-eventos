...
import br.com.fipgati.eventos.domain.repositorio.Repositorio;
...
public abstract class GenericDAO<T> implements Repositorio<T> {
    ...
    /**
     * Retorna uma instancia de Session para poder efetuar os procedimentos de
     * acesso com o banco, o hibernate não trabalha diretamente com
     * SessionFactory
     * 
     * @return Session
     */
